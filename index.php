			...
			<div class="swiper-wrapper">
				<div class="swiper-slide dark">
					...
					<div class="swiper-slide-bg"
						style="background-image: url('images/slider/swiper/Pensiunea Sophia-5.jpg');">
					</div>
				...
				<div class="swiper-slide dark">
					...
					<div class="swiper-slide-bg"
						style="background-image: url('images/slider/swiper/Pensiunea Sophia-41.jpg');">
					</div>
		...
		<div class="row col-mb-50 mb-0">
			<div class="col-sm-4 col-lg-3">
				<div class="feature-box fbox-center fbox-effect">
					<div class="fbox-icon">
						<i class="icon-house-user i-alt"></i>
					</div>
					<div class="fbox-content">
						<p> 8 camere cu baie proprie (de 2 sau 3 persoane) + living de 80 mp</p>
					</div>
				</div>
			</div>
			<div class="col-sm-4 col-lg-3">
			...
			<div class="col-sm-4 col-lg-3">
				<div class="feature-box fbox-center fbox-effect">
					<div class="fbox-icon">
						<i class="icon-check-circle i-alt"></i>
					</div>
					<div class="fbox-content">
						<p>Ciubăr</p>
					</div>
			...
			<div class="col-sm-4 col-lg-3">
				<div class="feature-box fbox-center fbox-effect">
					<div class="fbox-icon">
						<i class="icon-table-tennis i-alt"></i>
					</div>
					<div class="fbox-content">
						<p>Masă de ping-pong</p>
					</div>
				</div>
			</div>
			<div class="col-sm-4 col-lg-3">
				<div class="feature-box fbox-center fbox-effect">
					<div class="fbox-icon">
						<i class="icon-line-speaker i-alt"></i>
					</div>
					<div class="fbox-content">
						<p>Sistem de sonorizare (boxă mare cu bluetooth)</p>
					</div>
				</div>
			</div>
			<div class="col-sm-4 col-lg-3">
...
<div class="section parallax dark mb-0"
	style="background-image: url('images/testimonials/Pensiunea Sophia-17.jpg'); padding: 100px 0;"
	data-bottom-top="background-position:0px 300px;" data-top-bottom="background-position:0px -300px;">
	<div class="bg-overlay-content" style="background-color: rgba(0,0,0,0.5);"></div>
