...
<section class="content">
  ...
  <div class="card card-solid">
    ...
    <a href="users.php?source=add_user" class="btn bg-primary mb-4">
      <i class="fas fa-plus mr-2"></i>Adauga un utilizator nou
    </a>
          ...
          <div class="card bg-light d-flex flex-fill">
            ...
            <div class="card-body pt-0">
              <div class="row">
                ...
                <div class="col-5 text-center">
                  <a href="users.php?source=edit_user_photo&id=<?php echo $id ?>" title="schimba poza" class="change-photo">
            ...
            <div class="card-footer">
              <div class="text-right">
                <a href="users.php?delete=<?php echo $id; ?>" onClick="javascript:return confirm('Stergi utilizatorul <?php echo $username; ?>?')"; class="btn btn-sm bg-danger">
                  <i class="fas fa-trash-alt mr-2"></i>
                  Sterge
                </a>
                <a href="users.php?source=edit_user&u_id=<?php echo $id; ?>" class="btn btn-sm btn-primary">
                  <i class="fas fa-user-edit mr-2"></i>Modifica
                </a>
              </div>
            </div>
          </div>
