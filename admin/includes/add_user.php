...
<?php $page_title = "Adauga un utilizator"; ?>
        ...
        <div class="col-md-6">
          <div class="card card-secondary">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                <label for="customFile">Poza</label>
                <div class="custom-file">
                  <input type="file" class="custom-file-input" name="user_image" id="customFile">
                  <label class="custom-file-label" for="customFile">Alege o poza</label>
                </div>
              </div>
              ...
              <div class="form-group">
                <label for="repeat_user_password">Repeta parola*</label>
